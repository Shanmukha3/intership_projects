...
def history(request):
    ...
    return render(request,'hospital/admin_doctor_history.html')
...
#--------------------- FOR CHECKING HISTORY OF DISAPPROVED DOCTORS BY ADMIN START-------------------------


from django.shortcuts import render, get_object_or_404
from .models import Doctor  # Import your Doctor model

def doctor_history(request, doctor_id):
    doctor = get_object_or_404(Doctor, id=doctor_id)
    return render(request, 'hospital/admin_doctor_history.html', {'doctor': doctor})
